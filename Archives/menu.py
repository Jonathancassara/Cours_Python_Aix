...
logging.basicConfig(filename="logfilename.log", encoding='utf-8', level=logging.INFO,
...
def option1():
    ...
    fichier_csv = input("Quel est le nom de votre fichier annuaire ? " +
                        '\x1b[6;37;41m' + " Uniquement au format CSV " + '\x1b[0m')
    ...
    if file_extension.lower() == ".csv":
            try:
                ...
                answer = input(
                    '\x1b[0;30;44m' + "Voulez-vous créer le fichier ? oui ou non :" + '\x1b[0m').lower()
                if answer == 'oui':
